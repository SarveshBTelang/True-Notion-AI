...
# Use a LangChain-based vectorstore:
...
# Define a VectorStore class using FAISS and SentenceTransformer
class VectorStore:
...
def create_vectorstore(documents):
    ...
    """
    #model = SentenceTransformer("models/true_notion_vectorstore_model")
    model = SentenceTransformer("sentence-transformers/all-MiniLM-L6-v2")

    #Uncomment to save custom models to local
    #model.save("models/true_notion_vectorstore_model")
